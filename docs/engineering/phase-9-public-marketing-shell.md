...
| [`app/events/page.tsx`](../../app/events/page.tsx) | Server shell + [`EventsPageClient`](../../components/events/events-page-client.tsx): [`useRealtimeEvents(initial)`](../../lib/hooks/events/use-realtime-events.ts), `loadActiveEventsListData` | **Done:** hybrid initial list from server, realtime via Supabase channel; admin empty-state CTA uses `serverSnapshot` + client fallback like home hero. |

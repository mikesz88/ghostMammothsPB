...
import { useAdminEventDetailActions } from "@/lib/hooks/admin/events/use-admin-event-detail-actions";
import { useAdminEventDetailData } from "@/lib/hooks/admin/events/use-admin-event-detail-data";
import { useAdminEventDetailRealtime } from "@/lib/hooks/admin/events/use-admin-event-detail-realtime";

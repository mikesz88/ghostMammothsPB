import { EventDetailCourtColumn } from "@/components/events/event-detail/event-detail-court-column";
import { EventDetailQueueColumn } from "@/components/events/event-detail/event-detail-queue-column";

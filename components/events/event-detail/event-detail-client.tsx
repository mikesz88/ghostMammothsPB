...
import { EventDetailClientMain } from "@/components/events/event-detail/event-detail-client-main";
import { EventDetailClientModals } from "@/components/events/event-detail/event-detail-client-modals";

import { EventDetailCourtHeading } from "@/components/events/event-detail/event-detail-court-heading";
import { EventDetailCourtStatusBlock } from "@/components/events/event-detail/event-detail-court-status-block";
